...
DefineConstant[ interspace_UI     = { 4, Name StrCat[PathGeometricParameters, "Conductors' interspace" ] } ]                                            ;
...
S_total = Pi*(Rext*Rext-Delta*Delta);

//Parameters of the 2D Litz wires:

S_litz   = Pi * Delta * Delta   ;
Num_litz = S_total / S_litz     ;
